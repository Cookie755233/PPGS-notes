...
![IFR Flight Plan Submission](/images/ifrflightplan.png "IFR Flight Plan Submission")
...
4. **Weather** Avoidance *(use Airport Surveillance Radar to advise pilots four levels or precipitation—light, moderate, heavy, extreme)*
5. Safety alert to **terrain and obstacles**
6. **Emergency** assistance *(SAR; Aircraft conflict alert, Radar vectors)*
{{</ callout >}}
...
- If use **GPS** for navigation, you might be using **RNAV routes.**
	- **T-Routes** are established around or through busy terminal areas **under 18,000 ft.** Q-Routes facilitate high altitude above 18,000 ft.
...
| :----------------- | :--------------- | --------------: |
| MHA* – 6,000 ft    | 1 minute         |             200 |
| 6,001 – 14,000 ft  | 1 minute         |             230 |
| 14,001 ft and above| 1 minute 30 seconds |          265 |

![](/images/holdingentries.png "")


## Arrival (STAR)
- **Standard terminal arrival routes (STARs)** provide a standard method for leaving the enroute structure and entering a busy terminal area. STARs are established to simplify clearance delivery procedures and providing an expected plan of action to both pilots and controllers.
